...
export default function QuickActionButton({ action }: { action: QuickAction }) {
  ...
  return (
    <Link
      ...
      target="_blank"
      className="group flex min-h-[150px] items-center gap-4 rounded-3xl border border-slate-800/60 bg-slate-900/40 p-5 text-left transition hover:-translate-y-0.5 hover:border-sky-500/50 hover:bg-slate-900/80">
