            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="mt-2 max-w-3xl text-base text-slate-400">
                    Filter by team, role, or status, then open any row to promote them to staff, change their staff type,
                    or fully revoke access with audit-ready notes.
                  </p>
                </div>
              </div>
                ...
                <div className="mt-4 flex flex-wrap items-center justify-between gap-3 text-xs text-slate-400">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-slate-300">
                      Page {filteredRoster.length === 0 ? 0 : gridPage + 1} / {filteredRoster.length === 0 ? 0 : pageCount}
                    </span>
                    <Button
                      variant="outline"
                      size="sm"
                  ...
                  <div className="mt-6 space-y-4">
                    ...
                    <TabsContent value="team" className="space-y-3">
                      ...
                      <p className="text-xs text-slate-500">
                        Limited to roster rows tied to {teamLookup[exportTeam]}.
                      </p>
                    </TabsContent>
              ...
              <div className="space-y-5">
                ...
                <div className="rounded-2xl border border-slate-800/70 bg-slate-950/40 p-4">
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2">
                    ...
                    <Badge className={`rounded-full px-3 py-1 text-[0.65rem] ${accessStyles[activePerson.accessRole].badge}`}>
